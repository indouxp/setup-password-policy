...
2. t3600
  ...
  0 171110-175121 indou@t3600:setup-password-policy:$ ansible-playbook -i hosts site.yml
   ____________
  < PLAY [all] >
   ------------
          \   ^__^
  ...
  192.168.0.76               : ok=2    changed=0    unreachable=0    failed=0

  0 171110-175139 indou@t3600:setup-password-policy:$
